...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/05 21:09:20 by harici            #+#    #+#             */
/*   Updated: 2026/01/10 18:48:48 by harici           ###   ########.fr       */
/*                                                                            */
/******************************************************************************/
...
void add_env_entry(t_env_table *table, char *env_str, t_gc_context *contex);
...
void add_matches(DIR *directory, char *pattern, char **result, t_shell *shell);
